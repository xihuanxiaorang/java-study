...
## 0.2 2、第一个 Mybatis 程序📌

思路：数据库建表 --> 导入 Mybatis 等依赖 --> 配置数据库驱动 --> 编写代码 --> 测试

### 0.2.1 2.1、创建数据库表与测试数据
...
### 0.2.6 2.6、Mybatis 新增 Mapper 进行 CRUD 的步骤
...
### 0.5.1 5.1、SqlSessionFactoryBuilder
...
![|1000](attachments/202112101027470.png)
...
### 0.8.5 8.5、choose(when，otherwise)
