...
- [ ] ConfigurationClassPostProcessor 工厂后置处理器中的 `postProcessBeanDefinitionRegistry()` 方法，用于解析配置类（@Component、@ComponentScans、@ImportResource、@PropertySources、@Bean、@Import 注解）
- [ ] 事件监听机制与源码分析
