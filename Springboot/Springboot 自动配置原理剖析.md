...
![[Pasted image 20220507013216.png | 600]]
让咱们来看看 spring-boot-autoconfigure 模块下的 spring.factories 文件长什么样 =↓
![[Pasted image 20220507013645.png | 800]]
...
![[Pasted image 20220507014543.png | 1000]]
...
![[Pasted image 20220507020045.png | 800]]
...
![[Pasted image 20220507021036.png | 600]]
...
![[Pasted image 20220507022014.png | 600]]
...
![[Pasted image 20220507142924.png | 600]]
...
可以看到 getSystemProperties() 方法获取到的是系统配置 => ![[Pasted image 20220507151411.png | 600]]
而 getSystemEnvironment() 方法获取到的是系统环境 => ![[Pasted image 20220507151753.png | 600]]
...
![[Pasted image 20220507170650.png | 1000]]
...
![[Pasted image 20220507180913.png | 1000]]
...
![[Pasted image 20220507224549.png | 1000]]
...
![[Pasted image 20220507234243.png | 1000]]
...
![[Pasted image 20220507235456.png | 1000]]
...
![[Pasted image 20220508010802.png | 800]]
...
![[Pasted image 20220508014003.png | 1200]]
② configClasses => 配置类集合，此集合包含启动类(SampleWebFreeMarkerApplication)、扫描的组件(WelcomeController)以及获取到的自动配置类(xxxAutoConfiguration)
![[Pasted image 20220508014452.png | 1200]]
执行完该方法之后，再次查看 beanDefinitionMap 变量，发现集合中的数量变多了，说明已经将自动配置类中的组件的 bean 定义信息添加到该集合中了。
![[Pasted image 20220508014914.png | 1200]]
至于这个 this.reader.loadBeanDefinitions(configClasses); 怎么运行的，有兴趣的小伙伴可以自己看一下，这里我将其作为一个 ==TODO==，以后有机会分析一下该方法。
