...
![](attachments/Pasted%20image%2020220830022514.png)  
![|800](attachments/Pasted%20image%2020220830022717.png)  
本人是先选择到 5.3.5 版本，然后 **直接下载的 zip 压缩包**。  
![|250](attachments/Pasted%20image%2020220916043718.png)  
当然，小伙伴也可以按照自己喜欢通过 git 命令 `git clone https://gitee.com/liulei0713/spring-framework/tree/v5.3.5/` 下载。
...
找到项目根目录下的 `build.gradle` 和 `settings.gradle` 文件中的 `repositories` 关键字所在的地方，复制上面的内容粘贴到此处，如：  
`settings.gradle`：
...
![](attachments/Pasted%20image%2020220830030432.png)  
编译成功之后，使用 gradle 测试一下。  
![|500](attachments/Pasted%20image%2020220830031521.png)  
...
![](attachments/Pasted%20image%2020220830032133.png)  
...
![|800](attachments/Pasted%20image%2020220830032938.png)<br />  
...
![](attachments/Pasted%20image%2020220830033831.png)  
至此，Spring 源码环境搭建成功！🥳🥳🥳  
如果小伙伴不想自己搭建并且又想后续添加自己注释的话，可以到此处 [Release v1.0.0 · xihuanxiaorang/spring · GitHub](https://github.com/xihuanxiaorang/spring/releases/tag/v1.0.0) 下载我已经搭建好的。
