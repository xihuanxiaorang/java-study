...
![|500](../Attachments/Pasted%20image%2020220817144626.png)**子类可以修改工厂方法返回的对象类型**。
...
![|400](../Attachments/Pasted%20image%2020220817145042.png)**所有产品都必须实现同一个接口**
