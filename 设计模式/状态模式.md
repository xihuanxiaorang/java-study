...
![|500](attachments/state-zh.png)

## 2. 🙁问题

状态模式与 **有限状态机** 的概念紧密相关。  
![有限状态机|300](attachments/problem1.png)  
...
![文档对象的全部状态和转移|300](attachments/problem2-zh.png)  
...
![文档将工作委派给一个状态对象|400](attachments/solution-zh.png)  
...
![|500](attachments/Pasted%20image%2020221013233522.png)
