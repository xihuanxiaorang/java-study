...
![订阅机制允许对象订阅事件通知|400](attachments/solution1-zh.png)  
...
![发布者调用订阅者对象中的特定通知方法来通知订阅者|400](attachments/solution2-zh.png)  

## 4. 🚗真实世界类比

![杂志和报纸订阅|500](attachments/observer-comic-2-zh.png)  
...
- √开闭原则 _。 你无需修改发布者代码就能引入新的订阅者类 （如果是发布者接口则可轻松引入发布者类）。
- √你可以在运行时建立对象之间的联系。
- × 订阅者的通知顺序是随机的。
